...
class TestAPIEndpoints:
    ...
    def test_search_returns_rag_answer_when_available(self, mock_get_rag):
        """Test search endpoint returns RAG response when RAG system provides an answer"""
        mock_rag = Mock()
    ...
    @patch('servidor.routers.search._get_rag_system')
    def test_search_falls_back_to_web_when_rag_unavailable(self, mock_get_rag):
        """Test search endpoint falls back to web search when RAG system returns no answer"""
        mock_rag = Mock()
